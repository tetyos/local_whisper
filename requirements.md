...
- Download progress shall be displayed in a global progress bar at the bottom of the model selection view
- The progress bar shall show detailed file information (e.g., "Downloading model.bin (1.2 GB/1.5 GB)")
